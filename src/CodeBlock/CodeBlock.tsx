...
export interface CodeBlockProps {
  ...
  /** Callback to convert this code block to a mermaid diagram */
...
const MermaidIcon = () => (
  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M8 2v4M8 6L4 10M8 6l4 4M4 10v2M8 10v2M12 10v2" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
      ...
      {showHeader && (
        <div className="code-block__header">
          ...
          <div className="code-block__actions">
            ...
            {onConvertToMermaid && language !== 'mermaid' && (
              <button
                type="button"
                className="code-block__btn"
